<?php
    ...
    if(isset($_POST['guardar_datos'])){
        ...
        if ($_POST['nombre'] != "" && $_POST['categoria'] != "" && $_POST['cantidad'] != "" && $_POST['precio_costo'] != "" && $_POST['precio_venta'] != "" && $_POST['proveedor'] != "" && $_POST['imagen'] != ""){
            $producto = new Producto($nombre, $categoria, $cantidad, $precio_costo, $precio_venta, $proveedor, $imagen);
